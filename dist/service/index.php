...
$app->get('/repository/res/service/', 'Controller:home');
$app->get('/repository/res/service/audiences', 'Controller:audiences');
$app->get('/repository/res/service/search', 'Controller:search');
$app->get('/repository/res/service/proxy', 'Controller:proxy');
